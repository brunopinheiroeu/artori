...
import { Brain, Target, Users, Shield, BookOpen, TrendingUp, Search, Building2 } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-blue-50 to-cyan-50">
      ...
      <AppHeader>
        <div className="hidden md:flex items-center space-x-6">
          <Link to="/solutions" className="flex items-center space-x-2 text-gray-600 hover:text-indigo-600 transition-colors">
            <Building2 className="h-4 w-4" />
            <span>Solutions for Schools</span>
          </Link>
          <Link to="/login">
            <Button variant="ghost" className="text-gray-600 hover:text-indigo-600">Sign In</Button>
          </Link>
          <Link to="/login">
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        <GlassmorphismCard padding="p-12">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            Master high-stakes exams with responsible AI that explains its reasoning, 
            detects bias, and promotes deep learning alongside your teachers. 
            <span className="font-semibold text-indigo-600">Join 50,000+ students already studying smarter!</span>
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/login">
              <GradientButton size="lg" className="w-full sm:w-auto text-lg px-8 py-4">
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg mb-8">Practice for your specific exam with localized content</p>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg">Built for students, trusted by educators</p>
        </div>
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        <GlassmorphismCard padding="p-12">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Join thousands of students who are already using AI responsibly to ace their exams. 
            <span className="font-semibold text-violet-600">Start your free practice today!</span>
          </p>
          <Link to="/login">
            <GradientButton 
              size="lg" 
