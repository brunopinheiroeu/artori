              ...
              >
                <CardHeader>
                  ...
                  <CardDescription className="text-sm">
                    {classItem.activeStudents} active • {classItem.needsAttention} need attention
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <Button className={`w-full bg-gradient-to-r ${classItem.gradient} hover:shadow-lg transition-all`}>
                      View Class Details
                    </Button>
                  </div>
                </CardContent>
            ...
            <CardContent>
              <div className="space-y-4">
                {studentAlerts.map((alert, index) => (
                  <div key={index} className="flex items-center justify-between p-4 bg-white/40 rounded-lg border border-white/20">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">Last active: {alert.lastActive}</p>
                      </div>
                    </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <Card className="backdrop-blur-sm bg-white/60 border-white/20 hover:shadow-xl transition-all cursor-pointer">
            ...
            <CardContent className="text-center">
              <p className="text-sm text-gray-600 mb-4">View detailed performance analytics</p>
          ...
          <Card className="backdrop-blur-sm bg-white/60 border-white/20 hover:shadow-xl transition-all cursor-pointer">
            ...
            <CardContent className="text-center">
              <p className="text-sm text-gray-600 mb-4">Create and manage practice sets</p>
          ...
          <Card className="backdrop-blur-sm bg-white/60 border-white/20 hover:shadow-xl transition-all cursor-pointer">
            ...
            <CardContent className="text-center">
              <p className="text-sm text-gray-600 mb-4">Review AI explanations and add context</p>
          ...
          <Card className="backdrop-blur-sm bg-white/60 border-white/20 hover:shadow-xl transition-all cursor-pointer">
            ...
            <CardContent className="text-center">
              <p className="text-sm text-gray-600 mb-4">Access teaching materials and guides</p>
